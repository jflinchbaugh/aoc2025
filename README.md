...
TODO: add status badges for <https://github.com/John/{{scm/repo>}} workflows and issues
...
Evaluate the aoc2025.core namespace and a mulog publisher will start, sending pretty printed events to the console. Evaluate `(mulog-publisher)` to stop the mulog publisher.
